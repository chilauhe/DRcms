<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reply.aspx.cs" Inherits="DRcms.Web.Plugin.Feedback.admin.reply" ValidateRequest="false" %>
...
<div class="tab-content">
  <dl>
    <dt>所属站点</dt>
    <dd><%=new DRcms.BLL.sites().GetTitle(model.site_id)%></dd>
  </dl>
  <dl>
    <dt>联系人</dt>
