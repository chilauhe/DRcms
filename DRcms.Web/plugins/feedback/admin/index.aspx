<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="DRcms.Web.Plugin.Feedback.admin.index" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new DRcms.BLL.sites().GetTitle(int.Parse(Eval("site_id").ToString()))%></td>
