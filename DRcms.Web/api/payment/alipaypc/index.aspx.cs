...
namespace DRcms.Web.api.payment.alipaypc
{
    public partial class index : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //=============================获得订单信息================================
            string order_no = Common.Request.GetFormString("pay_order_no").ToUpper();
            decimal order_amount = Common.Request.GetFormDecimal("pay_order_amount", 0);
            string user_name = Common.Request.GetFormString("pay_user_name");
            string subject = Common.Request.GetFormString("pay_subject");
            ...
            sParaTemp.Add("exter_invoke_ip", Common.Request.GetIP()); ////获取客户端的IP地址
