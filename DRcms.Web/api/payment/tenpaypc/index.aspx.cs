...
using DRcms.API.Payment.tenpaypc;
using DRcms.Common;

namespace DRcms.Web.api.payment.tenpaypc
{
    public partial class index : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //=============================获得订单信息================================
            string order_no = Common.Request.GetFormString("pay_order_no").ToUpper(); //订单号
            decimal order_amount = Common.Request.GetFormDecimal("pay_order_amount", 0); //订单金额
            string user_name = Common.Request.GetFormString("pay_user_name"); //支付用户名
            string subject = Common.Request.GetFormString("pay_subject"); //备注说明
