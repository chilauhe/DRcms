...
namespace DRcms.Web.admin.settings
{
    public partial class templet_file_list : Web.UI.ManagePage
    {
        ...
        {
            skinName = Common.Request.GetQueryString("skin");
        ...
        {
            ChkAdminLevel("sys_site_templet", Enums.ActionEnum.Delete.ToString()); //检查权限
            ...
            AddAdminLog(Enums.ActionEnum.Delete.ToString(), "删除模板文件，模板:" + this.skinName);//记录日志
