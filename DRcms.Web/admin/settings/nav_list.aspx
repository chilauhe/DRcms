<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nav_list.aspx.cs" Inherits="DRcms.Web.admin.settings.nav_list" ValidateRequest="false" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a href="nav_edit.aspx?action=<%=Enums.ActionEnum.Add %>"><i class="iconfont icon-close"></i><span>新增</span></a></li>
      ...
      <li class="layer-<%#Eval("class_layer")%>">
        <div class="tbody">
          ...
          <div class="col index col-3">
            <a href="nav_edit.aspx?action=<%#Enums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a>
          ...
          <div class="col col-7">
            <a href="nav_edit.aspx?action=<%#Enums.ActionEnum.Add %>&id=<%#Eval("id")%>">添子级</a>
            <a href="nav_edit.aspx?action=<%#Enums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
          </div>
        </div>
      </li>
      </ItemTemplate>
