<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_config.aspx.cs" Inherits="DRcms.Web.admin.settings.sys_config" ValidateRequest="false" %>
...
<div class="tab-content" style="display:none">
  ...
  <dl>
    ...
    <dd>
      ...
      如果您尚未申请开通，请注册成功后填写您的用户名和通讯密钥均可正常使用。
    </dd>
  </dl>
</div>
<!--/手机短信设置-->
