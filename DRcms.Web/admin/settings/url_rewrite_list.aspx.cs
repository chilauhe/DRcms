...
namespace DRcms.Web.admin.settings
{
    public partial class url_rewrite_list : Web.UI.ManagePage
    {
        ...
        {
            this.channel = Common.Request.GetQueryString("channel");
            this.type = Common.Request.GetQueryString("type");
        ...
        {
            ChkAdminLevel("sys_url_rewrite", Enums.ActionEnum.Delete.ToString()); //检查权限
            ...
            AddAdminLog(Enums.ActionEnum.Delete.ToString(), "删除URL配置信息"); //记录日志
