<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="group_list.aspx.cs" Inherits="DRcms.Web.admin.users.group_list" ValidateRequest="false" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a href="group_edit.aspx?action=<%=Enums.ActionEnum.Add %>"><i class="iconfont icon-close"></i><span>新增</span></a></li>
  ...
  <asp:Repeater ID="rptList" runat="server">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
      ...
      <tr>
        ...
        <td>
          <a href="group_edit.aspx?action=<%#Enums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a>
        </td>
        ...
        <td align="center">
          <a href="group_edit.aspx?action=<%#Enums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
        </td>
      </tr>
      </ItemTemplate>
      <FooterTemplate>
