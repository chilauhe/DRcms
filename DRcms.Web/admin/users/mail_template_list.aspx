<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mail_template_list.aspx.cs" Inherits="DRcms.Web.admin.users.mail_template_list" ValidateRequest="false" %>
...
<div id="floatHead" class="toolbar-wrap">
  <div class="toolbar">
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          <li><a href="mail_template_edit.aspx?action=<%=Enums.ActionEnum.Add %>"><i class="iconfont icon-close"></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td><a href="mail_template_edit.aspx?action=<%#Enums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
    <td align="center"><%#Convert.ToInt32(Eval("is_sys")) == 1 ? "√" : "×"%></td>
    <td align="center"><a href="mail_template_edit.aspx?action=<%#Enums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
