...
namespace DRcms.Web.admin.manager
{
    public partial class manager_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("manager_list", Enums.ActionEnum.View.ToString()); //检查权限
        ...
        {
            ChkAdminLevel("manager_list", Enums.ActionEnum.Delete.ToString()); //检查权限
            int sucCount = 0;
            int errorCount = 0;
            BLL.manager bll = new BLL.manager();
            ...
            AddAdminLog(Enums.ActionEnum.Delete.ToString(), "删除管理员" + sucCount + "条，失败" + errorCount + "条"); //记录日志
