...
namespace DRcms.Web.admin.channel
{
    public partial class channel_edit : Web.UI.ManagePage
    {
        ...
        private string GetInherit(string page_type)
        {
            ...
            {
                case "index":
                    result = "DRcms.Web.UI.Page.article";
                    break;
                case "category":
                    result = "DRcms.Web.UI.Page.category";
                    break;
                case "list":
                    result = "DRcms.Web.UI.Page.article_list";
                    break;
                case "detail":
                    result = "DRcms.Web.UI.Page.article_show";
                    break;
            }
            return result;
        }
        ...
        private bool DoAdd()
        {
            ...
            AddAdminLog(Enums.ActionEnum.Add.ToString(), "添加频道" + model.title); //记录日志
            return true;
        }
        #endregion
        ...
        private bool DoEdit(int _id)
        {
            ...
            AddAdminLog(Enums.ActionEnum.Edit.ToString(), "修改频道" + model.title); //记录日志
            return true;
        }
        #endregion
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                ChkAdminLevel("sys_channel_manage", Enums.ActionEnum.Add.ToString()); //检查权限
                if (!DoAdd())
                {
                    JscriptMsg("保存过程中发生错误！", "");
                    return;
