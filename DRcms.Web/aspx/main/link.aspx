<%@ Page Language="C#" AutoEventWireup="true" Inherits="DRcms.Web.Plugin.Link.link" ValidateRequest="false" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by DRcms Template Engine at 3/22/2019 8:35:44 PM.
		本页面代码由DRcms模板引擎生成于 3/22/2019 8:35:44 PM. 
	*/
	...
	DataTable imgList = new DRcms.Web.Plugin.Link.link().get_link_list(0, "is_image=1");
	...
	templateBuilder.Append("\r\n                    </ul>\r\n                    \r\n                    <div class=\"txt\">\r\n                    ");
	DataTable txtList = new DRcms.Web.Plugin.Link.link().get_link_list(0, "is_image=0");
