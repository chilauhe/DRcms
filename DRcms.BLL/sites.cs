    ...
    public partial class sites
    {
        ...
        public bool Update(Model.sites model)
        {
            ...
            if (dal.Update(model, old_build_path))
            {
                ...
                {
                    //更改频道分类对应的目录名称
                    FileHelper.MoveDirectory(sysConfig.webpath + Constants.DIRECTORY_REWRITE_ASPX + "/" + old_build_path,
                        sysConfig.webpath + Constants.DIRECTORY_REWRITE_ASPX + "/" + model.build_path);
                    FileHelper.MoveDirectory(sysConfig.webpath + Constants.DIRECTORY_REWRITE_HTML + "/" + old_build_path,
                        sysConfig.webpath + Constants.DIRECTORY_REWRITE_HTML + "/" + model.build_path);
                }
                return true;
            }
            return false;
        ...
        public bool Exists(string build_path)
        {
            ...
            if (DirPathExists(sysConfig.webpath + "/" + Constants.DIRECTORY_REWRITE_ASPX + "/", build_path))
            {
                return true;
            }
            //与频道名称是否重名
