...
namespace DRcms.DAL
{
    public partial class plugin
    {
        ...
        public Model.plugin GetInfo(string dirPath)
        {
            ...
            if (!File.Exists(dirPath + Constants.FILE_PLUGIN_XML_CONFING))
                return aboutInfo;

            XmlDocument xml = new XmlDocument();
            xml.Load(dirPath + Constants.FILE_PLUGIN_XML_CONFING);
            try
            {
        ...
        {
            XmlNodeList xnList = XmlHelper.ReadNodes(dirPath + Constants.FILE_PLUGIN_XML_CONFING, xPath);
        ...
        {
            return XmlHelper.UpdateNodeInnerText(dirPath + Constants.FILE_PLUGIN_XML_CONFING, xPath, value);
        }
        ...
        {
            bool result = true;
            List<string> ls = ReadChildNodesValue(dirPath + Constants.FILE_PLUGIN_XML_CONFING, xPath);
            if (ls != null)
            {
