...
namespace DRcms.Common
{
    public class Mail
    {
        ...
        public static void send(string smtpserver, int enablessl, string userName, string pwd, string nickName, string strfrom, string strto, string subj, string bodys)
        {
