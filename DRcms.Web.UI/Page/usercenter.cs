...
namespace DRcms.Web.UI.Page
{
    public partial class usercenter : Web.UI.UserPage
    {
        ...
        protected override void InitPage()
        {
            ...
            {
                //清险Session
                HttpContext.Current.Session[Constants.SESSION_USER_INFO] = null;
                //清除Cookies
                Utils.WriteCookie(Constants.COOKIE_USER_NAME_REMEMBER, "DRcms", -43200);
                Utils.WriteCookie(Constants.COOKIE_USER_PWD_REMEMBER, "DRcms", -43200);
                Utils.WriteCookie("UserName", "DRcms", -1);
                Utils.WriteCookie("Password", "DRcms", -1);
                //自动登录,跳转URL
