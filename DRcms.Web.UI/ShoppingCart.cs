...
namespace DRcms.Web.UI
{
    ...
    public partial class ShopCart
    {
        ...
        {
            Utils.WriteCookie(Constants.COOKIE_SHOPPING_CART, "", -43200);
        }
        ...
        {
            Utils.WriteCookie(Constants.COOKIE_SHOPPING_CART, strValue, 43200); //存储一个月
        }
        ...
        {
            return Utils.GetCookie(Constants.COOKIE_SHOPPING_CART);
        }
